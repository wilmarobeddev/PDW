...
<body>
      ...
      <div class="container-fluid " style="width:600px; padding:0px; margin-top:5%; margin-right:5%;">


            <div class="container-fluid" style="background-color:white; color:black; margin:auto; padding:5px; margin-bottom:0px;">
                  ...
                  <div class="row">
                        ...
                        <img class="col" src="<?php echo $rutaimg; ?>" style="margin:auto;">
                        <div class="col col-sm-4"></div>
                  </div>
                  <form method="post" accept-charset="utf-8" name="frmUser" autocomplete="off" role="form" class="form-signin row">
                        ...
                        <div class="row" style="color:black; margin:auto; padding:18px; width: 450px; background-color: white;">
                              <div class="col-12">
